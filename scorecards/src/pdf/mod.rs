...
pub fn run_from_wcif(json: String, event: &str, round: usize, max_group_size: usize) {
    let (competitors, map, limit, competition) = super::wcif::get_scorecard_info_for_round(json, event, round);
